...
public class diettype extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diettype);
        ...
        backarrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(diettype.this, dietCategory.class));
            }
        });
...
//        final LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        ...
        String veg = getIntent().getStringExtra("vegDiet");
        category.setText(veg);
              database.getReference().child(veg).
                      addListenerForSingleValueEvent(new ValueEventListener() {
                          ...
                          public void onCancelled(@NonNull DatabaseError databaseError) {
                              Toast.makeText(diettype.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                              finish();
                          }
                      });
    }
